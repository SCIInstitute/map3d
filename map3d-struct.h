...
public:
  ...
  int borderWidth, titleHeight, globalBorderWidth, globalTitleHeight;
  int posx, posy, wrap_flag;    // default placement values
  int mainwidth, mainheight;
  int screenWidth, screenHeight;
  int borderless_xmin, borderless_xmax, borderless_ymin, borderless_ymax; // shape of borderless window
  ...
  GtkWidget* main_gl_widget; // widget whose context to load display 
                             //lists/texture memory and share with others
  GtkWidget* share_widget;   // widget with sharing GL context
