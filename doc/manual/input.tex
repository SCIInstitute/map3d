...
%    - release 6.2
% Last update: Fri Aug 26 07:26:37 2005 by Bryan Worthen
%    - release 6.4
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Input files}
...
%    and  
    ...
    {http://www.mathworks.com/access/helpdesk/help/techdoc/matlab_prog/ch02_d27.html#88951}
    ).  To include multiple surfaces requires an array of structures.
...
%        {3in}
%        {figures/map3d-indirection.epsf}
%  \epsfysize=3in
%  \centering\epsffile{figures/map3d-indirection.epsf}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  2 & 1 type nsegpts seglabel & segment number (1), type, number of
  points, label\_number \\ 
  ...
  nsegpts + 2 & X, Y, Z, radius & point location and radius of last point in
                              segment 1 \\ \hline
  . & 2 type nsegpts seglabel & segment number (2), segment type, number
  of points, and label\\ 
  . & X, Y, Z, radius & point location and radius of point 1 \\
  . & X, Y, Z, radius & point location and radius of point 2 \\
  . & . & . \\
  . & . & . \\
  . & X, Y, Z, radius & point location and radius of last point in
                              segment 2 \\ \hline
  . & . & . \\
  . & . & . \\
  . & . & . \\
