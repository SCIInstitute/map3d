...
%begin{latexonly}
  ...
  {\centerline{\includegraphics[height=2in]{figures/mouse.epsf}}}
  \newcommand{\filesdialogone}%
  {\centerline{\includegraphics[width=\columnwidth]
      {figures/filesdialog1.epsf}}}
  \newcommand{\filesdialogthree}%
  {\centerline{\includegraphics[width=\columnwidth]
      {figures/filesdialog3.epsf}}}
  \newcommand{\savedialog}%
  {\centerline{\includegraphics[height=4in]{figures/savedialog.epsf}}}
  \newcommand{\fiducialswindow}%
  {\centerline{\includegraphics[width=5in]
  {figures/fiducialswindow.epsf}}} 
  \newcommand{\scaledialog}%
  {\centerline{\includegraphics[height=2.5in]{figures/scaledialog.epsf}}}
  \newcommand{\contourdialog}%
  {\centerline{\includegraphics[height=2.5in]{figures/contourdialog.epsf}}}
  \newcommand{\colorpicker}%
  {\centerline{\includegraphics[height=1in]{figures/colorpicker.epsf}}}
  \newcommand{\sizepicker}%
  {\centerline{\includegraphics[height=1in]{figures/sizepicker.epsf}}}
%end{latexonly}
\begin{htmlonly}
  \newcommand{\mouseaction}{%
...
% If you load a Time Series Container File, there will be some new columns that
% appear - one for the container file, one for the number of time series within
% the container file, and then the name of the time series file that gets loaded
% will appear in the the Time Series File column.
If you click on the ``New Surface'' button, an empty row will pop up,
allowing you to add a surface from scratch.
 
None of the changes you make will take effect until you click on the
...
Also note that this window allows you to run \map{} without any arguments.
