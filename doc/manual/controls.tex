...
%begin{latexonly}
  ...
  {\centerline{\includegraphics[width=\columnwidth]{figures/fidwindows.pdf}}} 
  \newcommand{\fidexamples}%
  {\centerline{\includegraphics[width=\columnwidth]{figures/fidexamples.pdf}}} 
...
\begin{htmlonly}
  ...
  {../figures/fidwindows.jpg}}
  \newcommand{\fidexamples}{%
  \htmladdimg[align=top,alt="Fiducial Display Examples"]
  {../figures/fidexamples.jpg}}
  \newcommand{\scaledialog}{%
...
\begin{figure}[htb]
  ...
  \caption{\label{fig:fidexamples} Examples of fiducial displays.  Panels
    ...
    potential maps.  Panels D and E show displays of shaded acivation maps
    with superimposed potentials (Panel C) and a single acivation contour
    (Panel D).  Panel E shows a conoour display of ativation time. }
\end{figure}


Figure~\ref{fig:fidexamples} shows different forms of display of activation
times using the fiducial display options.  
