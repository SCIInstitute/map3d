...
//    if (mesh->use_spacing) contour_num = 0;
  ...
  action->setData(mark_all_node); action->setCheckable(true); action->setChecked(all_node_num == 0);
  action = subsubmenu->addAction("Channel #");
  action->setData(mark_all_channel); action->setCheckable(true); action->setChecked(all_node_num == 1);
  action = subsubmenu->addAction("Data value");
  action->setData(mark_all_value); action->setCheckable(true); action->setChecked(all_node_num == 2);
  action = subsubmenu->addAction("Fiducial value");
  action->setData(mark_all_fid); action->setCheckable(true); action->setChecked(all_node_num == 3);
  ...
  action = subsubmenu->addAction("Node #");
  action->setData(mark_extrema_node); action->setCheckable(true); action->setChecked(ext_node_num == 0);
  action = subsubmenu->addAction("Channel #");
  action->setData(mark_extrema_channel); action->setCheckable(true); action->setChecked(ext_node_num == 1);
  action = subsubmenu->addAction("Data value");
  action->setData(mark_extrema_value); action->setCheckable(true); action->setChecked(ext_node_num == 2);
  ...
  action = subsubmenu->addAction("Node #");
  action->setData(mark_ts_node); action->setCheckable(true); action->setChecked(pick_node_num == 0);
  action = subsubmenu->addAction("Channel #");
  action->setData(mark_ts_channel); action->setCheckable(true); action->setChecked(pick_node_num == 1);
  action = subsubmenu->addAction("Data value");
  action->setData(mark_ts_value); action->setCheckable(true); action->setChecked(pick_node_num == 2);
  ...
  action = subsubmenu->addAction("Node #");
  action->setData(mark_lead_node); action->setCheckable(true); action->setChecked(lead_node_num == 0);
  action = subsubmenu->addAction("Channel #");
  action->setData(mark_lead_channel); action->setCheckable(true); action->setChecked(lead_node_num == 1);
  action = subsubmenu->addAction("Data value");
  action->setData(mark_lead_value); action->setCheckable(true); action->setChecked(lead_node_num == 2);
  action = subsubmenu->addAction("Lead labels");
  action->setData(mark_lead_labels); action->setCheckable(true); action->setChecked(lead_node_num == 3);
